...
import { FaPuzzlePiece, FaTrophy, FaClock, FaSignOutAlt, FaChartBar } from 'react-icons/fa';
...
const Home = ({ user }) => {
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      <div className="bg-white rounded-lg shadow-lg p-6 transform transition-transform hover:scale-105">
        <h3 className="text-lg font-semibold text-gray-900 flex items-center">
          <FaPuzzlePiece className="mr-2" /> Puzzles Completed
        </h3>
        <p className="text-3xl font-bold text-blue-600">{stats.completed}</p>
      </div>
      <div className="bg-white rounded-lg shadow-lg p-6 transform transition-transform hover:scale-105">
        <h3 className="text-lg font-semibold text-gray-900 flex items-center">
          <FaTrophy className="mr-2" /> Best Time
        </h3>
      ...
      <div className="bg-white rounded-lg shadow-lg p-6 transform transition-transform hover:scale-105">
        <h3 className="text-lg font-semibold text-gray-900 flex items-center">
          <FaClock className="mr-2" /> Average Time
        </h3>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-500 to-purple-600 relative">
      {/* Header Section */}
        ...
        <div className="flex flex-col md:flex-row md:items-center md:gap-4 pb-5 md:pb-0">
          ...
          <div className="hidden md:flex md:gap-2 mt-4 md:mt-0">
            ...
            <button
              ...
              className="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 transition duration-200 flex items-center"
            >
        ...
        <div className="bg-white rounded-lg shadow-lg mb-8">
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              ].map(({ type, title, description, bgColor, hoverColor, textColor }) => (
                <button
                  key={type}
                  onClick={() => handleStartPuzzle(type)}
                  className={`flex items-center justify-center p-4 ${bgColor} rounded-lg ${hoverColor} transition duration-200 transform hover:scale-105`}
                >
                  <div className="text-center">
